...
using CarAuctionBids_DataAccess.Enums;
...
namespace CarAuctionBids_Business.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, ApiResponse response, IMapper mapper, IConfiguration _configuration, DataContext context)
        {
